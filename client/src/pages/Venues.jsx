...
import { motion, fadeInUp } from "../components/animation/Animation"; // Only import fadeIn and motion
...
const Venues = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{t("venues.title")} - SwatVenue</title>
        <meta
          name="description"
      ...
      <div className="bg-gray-50 dark:bg-surface-900 min-h-screen">
        <div className="flex">
          ...
          <motion.aside
            ...
            animate="visible"
            variants={fadeInUp}
            className="hidden lg:block w-80 h-[calc(100vh-80px)] sticky top-[70px] overflow-y-auto border-r border-gray-200 dark:border-surface-700"
          >
            <FilterSidebar
              isOpen={true}
              onClose={() => setFilterSidebarOpen(false)}
          ...
          {/* Main Content - Only animation wrapper added */}
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                      ...
                      {filteredAndSortedVenues.length === 1
                        ...
                        : t("venues.venues")}{" "}
                      {t("venues.found")}
                      {hasActiveFilters && ` ${t("venues.filters_applied")}`}
                    </p>
                  </div>
                </div>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                ...
                <div className="w-full lg:hidden flex items-center justify-between gap-4">
                  ...
                  >
                    ...
                    <span className="text-black dark:text-white">{t("venues.filters_button")}</span>
                    {hasActiveFilters && (
                  ...
                  <div className="flex-1">
                    ...
                    >
                      <option value="name">{t("venues.sort_name")}</option>
                      <option value="price-low">{t("venues.sort_price_low")}</option>
                      <option value="price-high">{t("venues.sort_price_high")}</option>
                      <option value="rating">{t("venues.sort_rating")}</option>
                      <option value="capacity">{t("venues.sort_capacity")}</option>
                    </select>
                  </div>
                </div>
                  ...
                  <div className="flex-1 max-w-md">
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleSearchChange}
                        onKeyPress={handleKeyPress}
                        placeholder={t("venues.search_placeholder_desktop")}
              ...
              {filteredAndSortedVenues.length === 0 ? (
                <div className="text-center py-16">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                    {t("venues.no_results_title")}
                  </h3>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    {filters.search.trim() !== ""
                      ? t("venues.no_results_search", { search: filters.search })
                      : t("venues.no_results_filters")}
                  </p>
